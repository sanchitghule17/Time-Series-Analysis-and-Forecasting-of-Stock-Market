...
[![Streamlit](https://img.shields.io/badge/Streamlit-App-red?logo=streamlit)](#launch-the-streamlit-app)
[![License](https://img.shields.io/github/license/sanchitghule17/Time-Series-Analysis-and-Forecasting-of-Stock-Market)](LICENSE)

An end-to-end academic project that shows how to download equity-price data, explore temporal patterns, train both classical and deep-learning models, and serve interactive forecasts through a Streamlit web application.
